...
const NAV = [
  ...
  { label: 'Insights',      href: BASE + '/artigos/',            key: 'artigos' },
];
      ...
      <div class="footer-grid">
        ...
        <div class="footer-nav">
          ...
          <div class="footer-nav-links">
            ...
            <a href="${BASE}/artigos/">Insights</a>
            <a href="https://ails.eumaisempresa.com.br/">AILs</a>
            <span class="footer-nav-subtitle">Transparência</span>
            <a href="${BASE}/governanca/">Governança</a>
          </div>
        </div>
